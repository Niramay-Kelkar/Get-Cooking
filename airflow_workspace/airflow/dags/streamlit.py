...
def main():
    ...
    st.markdown(
        "An ML powered app <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Octicons-mark-github.svg/600px-Octicons-mark-github.svg.png' width='20' height='20' > </a> ",
    ...
    st.markdown(
        "For example, what recipes can you make with the food in your kitchen? :bento: Our ML based model will look through over thousands of recipes to find top matches for you! :mag: Try it out for yourself below! :arrow_down:"
    )
